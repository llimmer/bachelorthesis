...
use bachelorthesis::{BLOCKSIZE, sort, THRESHOLD};
...
pub fn main() {
    ...
    for k in start_algo..=max_algo {
        match k {
            1 => println!("IPS2Ra sequential - BLOCKSIZE: {}, THRESHOLD: {}", BLOCKSIZE, THRESHOLD),
            2 => println!("Rust sort()"),
            3 => println!("Rust sort_unstable()"),
