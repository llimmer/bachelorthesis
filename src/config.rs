...
pub const HUGE_PAGES_2M: usize = 100; // Number of 2 MiB hugepages allocated in main memory (-> Setup script)
pub const HUGE_PAGES_1G: usize = 3; // Number of 1 GiB hugepages allocated in main memory (-> Setup script)
pub const HUGE_PAGE_SIZE_2M: usize = 8192; //2 * 1024 * 1024; // Number of bytes per 2M hugepage
pub const HUGE_PAGE_SIZE_1G: usize = 8192; //1024 * 1024 * 1024; // Number of bytes per 1G hugepage
