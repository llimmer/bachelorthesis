...
pub const HUGE_PAGES_2M: usize = 2000; // Number of 2 MiB hugepages allocated in main memory (-> Setup script)
pub const HUGE_PAGES_1G: usize = 40; // Number of 1 GiB hugepages allocated in main memory (-> Setup script)
